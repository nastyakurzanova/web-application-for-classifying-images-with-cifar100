...
# Список классов
imageClassList = {24: 'cockroach', 54: 'orchid', 84: 'table'}  # Добавьте свои классы здесь
...
def predictImageData(modelName, filePath):
    ...
    sess = onnxruntime.InferenceSession(r'C:\Users\Danial\Desktop\9 sem\mppr\dz3\dz3_mppr\media\models\cifar100_CNN_RESNET20.onnx')
